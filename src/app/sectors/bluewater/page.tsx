...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: 'https://images.unsplash.com/photo-1495521821757-a1efb6729352?w=1200&h=630&fit=crop',
        width: 1200,
        height: 630,
...
export default function BlueWaterInsurancePage() {
  ...
  return (
    <>
      ...
      {/* Hero Section */}
      <section className="h-[45vh] bg-gradient-to-br from-sky-600 via-cyan-500 to-blue-600 text-white flex items-center justify-center relative overflow-hidden">
