...
export default function RacingBoatInsurancePage() {
  ...
  return (
    <>
      ...
      {/* Hero Section */}
      <section className="h-[52vh] bg-gradient-to-br from-sky-600 via-blue-600 to-indigo-600 text-white flex items-center justify-center relative overflow-hidden">
